...
/* Defines required for manual pin control */
...
static ARM_DRIVER_GPIO *IO_Driver_CAM_RST = &ARM_Driver_GPIO_(MT9M114_CAMERA_RESET_GPIO_PORT);

/* MT9M114 camera power GPIO port */
extern ARM_DRIVER_GPIO ARM_Driver_GPIO_(MT9M114_CAMERA_POWER_GPIO_PORT);
static ARM_DRIVER_GPIO *IO_Driver_CAM_PWR = &ARM_Driver_GPIO_(MT9M114_CAMERA_POWER_GPIO_PORT);

/* GT911 touch-controller reset GPIO port */
