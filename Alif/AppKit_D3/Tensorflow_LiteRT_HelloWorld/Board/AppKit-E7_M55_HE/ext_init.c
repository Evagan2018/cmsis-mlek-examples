...
void ext_init (void) {
  ...
  IO_Driver_LCD_RST->Initialize(BOARD_LCD_BACKLIGHT_GPIO_PIN, NULL);
  IO_Driver_LCD_RST->PowerControl(BOARD_LCD_BACKLIGHT_GPIO_PIN, ARM_POWER_FULL);
  IO_Driver_LCD_RST->SetValue(BOARD_LCD_BACKLIGHT_GPIO_PIN, GPIO_PIN_OUTPUT_STATE_LOW);
  IO_Driver_LCD_RST->SetDirection(BOARD_LCD_BACKLIGHT_GPIO_PIN, GPIO_PIN_DIRECTION_OUTPUT);
}
